...
class DiscountController extends Controller
{
    ...
    public function copanStore(CopanRequest $request): \Illuminate\Http\RedirectResponse
    {
        $inputs = $request->all();
        //date fixed
    ...
    public function copanUpdate(CopanRequest $request, Copan $copan): \Illuminate\Http\RedirectResponse
    {
        $inputs = $request->all();
        //date fixed
        $realTimestampStart = substr($request->start_date, 0, 10);
    ...
    public function copanDestroy(Copan $copan): \Illuminate\Http\RedirectResponse
    {
        $copan->delete();
