...
class OrderController extends Controller
{
    ...
    public function changeSendStatus(Order $order): \Illuminate\Http\RedirectResponse
    {
    ...
    public function changeOrderStatus(Order $order): \Illuminate\Http\RedirectResponse
    {
