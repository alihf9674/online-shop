...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('payment')->group(function () {
            ...
            Route::get('/offline', [PaymentController::class, 'offline'])->name('admin.market.payment.sending');
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        Route::prefix('comment')->group(function () {
            ...
            Route::delete('/status/{comment}', [ContentCommentController::class, 'status'])->name('admin.content.comment.status');
            Route::delete('/approved/{comment}', [ContentCommentController::class, 'approved'])->name('admin.content.comment.approved');
            Route::delete('/answer/{comment}', [ContentCommentController::class, 'answer'])->name('admin.content.comment.answer');
        });

        //faq
        Route::prefix('faq')->group(function () {
            Route::get('/', [FAQController::class, 'index'])->name('admin.content.faq.index');
            Route::get('/create', [FAQController::class, 'create'])->name('admin.content.faq.show');
        ...
        Route::prefix('post')->group(function () {
            ...
            Route::get('/edit/{post}id', [PostController::class, 'edit'])->name('admin.content.post.edit');
